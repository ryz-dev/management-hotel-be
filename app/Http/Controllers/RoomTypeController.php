...
class RoomTypeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $room_type->nama_room_type = $request->namaRoomType;
        $room_type->banquet = $request->banquet == 'ya' ? true : false;
        $room_type->status = true;
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(RoomType $roomType, $id)
    {
